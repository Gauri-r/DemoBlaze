...
public class PurchaseLaptop_PageObject 
	{
		WebDriver driver;
		Properties propPath;
		By xpathlaptop_macprobook_link;
		...
		public PurchaseLaptop_PageObject(WebDriver driver,Properties propPath)
			{
				// TODO Auto-generated constructor stub
				this.driver=driver;
				this.propPath=propPath;
				xpathlaptop_macprobook_link=By.xpath(propPath.getProperty("xpathlaptop_macprobook_link"));
		...
		public WebElement getClickOnLaptop()
			{
				return driver.findElement(xpathlaptop_macprobook_link);
			}
